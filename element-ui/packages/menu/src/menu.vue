<script type="text/jsx">
  ...
  import Menubar from 'element-ui/src/com.com.itheima.utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from 'element-ui/src/com.com.itheima.utils/dom';
