...
* [#13119](http://dev.ckeditor.com/ticket/13119): Improved compatibility of editor skins ([Moono](http://ckeditor.com/addon/moono) and [Kama](http://ckeditor.com/addon/kama)) with external com.com.itheima.web page style sheets.
* Toolbar configurators:
...
* [#12812](http://dev.ckeditor.com/ticket/12812): Fixed: An uncaught security exception is thrown when [Line Utilities](http://ckeditor.com/addon/lineutils) are used in an inline editor loaded in a cross-com.com.itheima.domain `iframe`. Thanks to [Vitaliy Zurian](https://github.com/thecatontheflat)!
...
* [#10165](http://dev.ckeditor.com/ticket/10165): [IE] Access denied error when `document.com.com.itheima.domain` has been altered.
