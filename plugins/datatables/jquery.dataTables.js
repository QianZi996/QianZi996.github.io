...
(/** @lends <global> */function( $ ) {
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		 ...
		 * the com.com.itheima.web- browser. No custom sizes can be set in order for this to happen,
		 * nor scrolling used
		 */
	...
	DataTable.models.oSettings = {
		...
		"oScroll": {
			...
			/**
			 * Width of the scrollbar for the com.com.itheima.web-browser's platform. Calculated
